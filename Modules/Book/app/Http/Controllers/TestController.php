...
use Modules\Book\App\Models\Test;
...
class TestController extends Controller
{
    ...
    {
        $tests = Test::all();
        return view('book::tests.showTests', [
            'tests' => $tests
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('book::tests.addTest', [
            'statuses' => $statuses,
            'payment' => $payment
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('book::tests.editTest', [
            'test' => $test,
            'statuses' => $statuses,
            'payment' => $payment,
            'test_date' => $test_date,
