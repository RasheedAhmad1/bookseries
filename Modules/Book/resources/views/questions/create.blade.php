    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-primary">New Question</li>
            </ol>
        </nav>
    </div>
    <!--/ Dynamic Breadcrumb -->
    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <form action="{{ route('question.store', Crypt::encrypt($unit->id)) }}" method="POST" class="card-body"
                    ...
                    <div class="row mb-3 mt-5">
                        <div class="col-sm-12">
                            ...
                            <textarea type="text" name="explanation" id="editor2" class="form-control" placeholder="Enter section description"></textarea>
                        </div>
                    </div>
