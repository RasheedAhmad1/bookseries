            ...
            <div class="card mb-4">
                <div class="card-header col-md-12 d-flex justify-content-between align-items-center">
                    <h5 class="card-header text-primary">
                        <li class="fa fa-align-justify"></li> New Unit
                    </h5>
                </div>
                <div class="menu-divider mb-4"></div>
                <form action="{{ route('unit.store', Crypt::encrypt($section->id)) }}" method="POST" class="card-body"
                    ...
                    <div class="row mb-3">
                        ...
                        {{-- Section title --}}
                        <div class="col-sm-6">
                            <label class=" col-form-label text-sm-end" for="title">Section</label>
                            <input type="text" id="alignment-book" class="form-control" value="{{ $section->title }}"
                                disabled />
                            <input type="hidden" name="section_id" id="alignment-unit" class="form-control"
                                value="{{ $section->id }}" />
                        </div>
                    </div>
